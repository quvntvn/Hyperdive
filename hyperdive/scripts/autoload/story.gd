...
const CHAPTERS: Array[Dictionary] = [
	...
	{"n": 1,  "type": "play",  "mode": "fall",    "objective": {"kind": "descent", "value": 150},  "text_when": "after",  "theme": "sunset", "title": "2028", "image": "res://assets/story/ch01.png",
...
# → zéro fuite vers les autres chapitres/modes. Le dict catalogue est INCHANGÉ (descent 150 m) :
