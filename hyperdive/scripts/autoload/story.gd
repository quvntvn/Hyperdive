...
const CHAPTERS: Array[Dictionary] = [
	...
	{"n": 3,  "type": "play",  "mode": "fall",    "objective": {"kind": "distance", "value": 450},  "text_when": "before", "title": "Le contrat", "image": "res://assets/story/ch03.png",
		"text": "Vertex. Deux tours jumelles qui crèvent les nuages, une fortune sans fond, et au centre de tout — une intelligence. Une IA qui gère l'empire, qu'aucun humain ne comprend vraiment.\nMa mission : entrer, atteindre le cœur du système, en extraire ce qu'ils y cachent.\nL'homme gris ne m'a pas dit pourquoi moi. J'aurais dû me poser la question."},
	{"n": 4,  "type": "play",  "mode": "fall",    "objective": {"kind": "survive",  "value": 24},   "text_when": "before", "title": "L'infiltration", "image": "res://assets/story/ch04.png",
		"text": "Je suis entré sans résistance. Trop simple. Les portes s'ouvraient avant que je les touche, les caméras tournaient la tête. Comme si la tour me laissait monter.\nComme si elle m'attendait.\nJe n'ai pas écouté cette voix au fond de moi qui disait : fais demi-tour."},
	{"n": 5,  "type": "story", "title": "Le piège", "image": "res://assets/story/ch05.png",
	...
	{"n": 6,  "type": "play",  "mode": "fall",    "objective": {"kind": "distance", "value": 520},  "text_when": "after",  "title": "La machine", "image": "res://assets/story/ch06.png",
	...
	{"n": 7,  "type": "story", "title": "Le visage", "image": "res://assets/story/ch07.png",
	...
	{"n": 8,  "type": "play",  "mode": "fall",    "objective": {"kind": "survive",  "value": 30},   "text_when": "after",  "title": "L'enfance", "image": "res://assets/story/ch08.png",
	...
	{"n": 9,  "type": "story", "title": "Le corps brisé", "image": "res://assets/story/ch09.png",
	...
	{"n": 10, "type": "play",  "mode": "fall",    "objective": {"kind": "dodge",    "value": 18},   "text_when": "after",  "title": "Pas un accident", "image": "res://assets/story/ch10.png",
	...
	{"n": 11, "type": "story", "title": "La voix", "image": "res://assets/story/ch11.png",
	...
	{"n": 12, "type": "play",  "mode": "fall",    "objective": {"kind": "distance", "value": 640},  "text_when": "after",  "title": "Mascarade", "image": "res://assets/story/ch12.png",
	...
	{"n": 16, "type": "play",  "mode": "fall",    "objective": {"kind": "survive",  "value": 38},   "text_when": "before", "title": "Diffusion", "image": "res://assets/story/ch16.png",
		"text": "Alors elle me fait tomber. Encore. Mais maintenant je sais à qui s'adresse le spectacle.\nChaque chute est un signal lancé dans le noir. Un appel diffusé vers un fantôme.\nRegarde. Regarde ton fils. Il suffit que tu te montres et tout s'arrête.\nJe tombe pour appâter un homme que je ne me rappelle même plus."},
	{"n": 17, "type": "play",  "mode": "fall",    "objective": {"kind": "dodge",    "value": 30},   "text_when": "after",  "title": "Résister", "image": "res://assets/story/ch17.png",
	...
	{"n": 18, "type": "story", "title": "La faille", "image": "res://assets/story/ch18.png",
	...
	{"n": 19, "type": "play",  "mode": "fall",    "objective": {"kind": "survive",  "value": 44},   "text_when": "after",  "title": "Le refus", "image": "res://assets/story/ch19.png",
	...
	{"n": 20, "type": "story", "title": "L'inversion", "image": "res://assets/story/ch20.png",
	...
	{"n": 21, "type": "play",  "mode": "jetpack", "objective": {"kind": "distance", "value": 760},  "text_when": "after",  "title": "Vers le haut", "image": "res://assets/story/ch21.png",
	...
	{"n": 22, "type": "story", "title": "Le cœur", "image": "res://assets/story/ch22.png",
	...
	{"n": 23, "type": "play",  "mode": "jetpack", "objective": {"kind": "survive",  "value": 48},   "text_when": "after",  "title": "Contre-courant", "image": "res://assets/story/ch23.png",
	...
	{"n": 24, "type": "play",  "mode": "fall",    "objective": {"kind": "distance", "value": 850},  "text_when": "after",  "title": "Rechute", "image": "res://assets/story/ch24.png",
	...
	{"n": 25, "type": "story", "title": "Vertex est tombée", "image": "res://assets/story/ch25.png",
	...
	{"n": 26, "type": "play",  "mode": "jetpack", "objective": {"kind": "survive",  "value": 52},   "text_when": "after",  "title": "Commanditaire", "image": "res://assets/story/ch26.png",
	...
	{"n": 27, "type": "story", "title": "Le but", "image": "res://assets/story/ch27.png",
	...
	{"n": 28, "type": "play",  "mode": "jetpack", "objective": {"kind": "distance", "value": 1000}, "text_when": "after",  "title": "Plus haut", "image": "res://assets/story/ch28.png",
	...
	{"n": 29, "type": "story", "title": "Des échos", "image": "res://assets/story/ch29.png",
	...
	{"n": 30, "type": "story", "title": "Les autres", "image": "res://assets/story/ch30.png",
	...
	{"n": 31, "type": "story", "title": "Le réseau", "image": "res://assets/story/ch31.png",
	...
	{"n": 32, "type": "play",  "mode": "fall",    "objective": {"kind": "dodge",    "value": 40},   "text_when": "after",  "title": "Ensemble", "image": "res://assets/story/ch32.png",
	...
	{"n": 33, "type": "story", "title": "Le réparé", "image": "res://assets/story/ch33.png",
	...
	{"n": 34, "type": "play",  "mode": "jetpack", "objective": {"kind": "survive",  "value": 58},   "text_when": "after",  "title": "Le lien", "image": "res://assets/story/ch34.png",
	...
	{"n": 35, "type": "story", "title": "Le signal", "image": "res://assets/story/ch35.png",
	...
	{"n": 36, "type": "play",  "mode": "fall",    "objective": {"kind": "distance", "value": 1100}, "text_when": "before", "title": "Retrouvailles", "image": "res://assets/story/ch36.png",
		"text": "Il monte vers moi et je devrais pleurer, je devrais crier, je devrais le reconnaître.\nMais quelque chose cloche.\nSes traits sont justes — le front, la mâchoire, les yeux que j'ai dans le miroir. Tout est exact. Trop exact. Comme un portrait dessiné par quelqu'un qui aurait lu une description sans jamais voir le modèle.\nMon corps veut courir vers lui. Mon instinct me retient. Je tombe vers lui en doutant."},
	{"n": 37, "type": "story", "title": "La question", "image": "res://assets/story/ch37.png",
	...
	{"n": 38, "type": "play",  "mode": "jetpack", "objective": {"kind": "dodge",    "value": 48},   "text_when": "after",  "title": "Le blanc", "image": "res://assets/story/ch38.png",
	...
	{"n": 39, "type": "story", "title": "Monté contre", "image": "res://assets/story/ch39.png",
	...
	{"n": 40, "type": "play",  "mode": "fall",    "objective": {"kind": "distance", "value": 1300}, "text_when": "after",  "title": "Fin", "image": "res://assets/story/ch40.png",
